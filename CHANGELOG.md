...
- Кеширование состояния загруженных подписок и протестированных конфигураций.
- Автоматическая актуализация состояния кеша.
- Статистические отчеты о состоянии кеша в формате csv.
...
- Тестирование доступности обрабатываемых конфигураций (PING).
